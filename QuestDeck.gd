...
func init_quests():
	...
	q30.description = colorize_text("Построй 8 культурных районов без промышленных соседей")
	q30.reward_cards = 5
